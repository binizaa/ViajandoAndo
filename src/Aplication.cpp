...
void Aplication::dateAndAirlineFilter(){
    clear();
    string airline;
    int day, month, year;
...
void Aplication::showReservations() {
    clear();
